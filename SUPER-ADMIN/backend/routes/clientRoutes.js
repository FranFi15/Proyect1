...
// import { protectAdmin } from '../middleware/adminAuthMiddleware.js'; // Middleware para proteger rutas de admin

const router = express.Router();

// --- RUTAS PARA EL PANEL DE ADMIN (deberían estar protegidas) ---
router.route('/')
    .get(getClients)      // Ejemplo: .get(protectAdmin, getClients)
    .post(registerClient); // Ejemplo: .post(protectAdmin, registerClient)
