...
# Este script se ejecuta en el servidor de EAS antes de que comience el build.
# Su propósito es crear el archivo google-services.json a partir de un "secret".

set -e # Termina el script inmediatamente si un comando falla.

# 1. Verifica si la variable de entorno (el secret) existe.
