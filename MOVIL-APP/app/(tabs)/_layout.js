...
export default function TabsLayout() {
  const { user } = useAuth(); // Get the user info from AuthContext to access unreadNotificationsCount

  return (
    <Tabs 
      screenOptions={{
        tabBarActiveTintColor: '#150224', // Your active tab color
        headerTitleAlign: 'center',
        headerTitle: (props) => <HeaderLogoTitle {...props} />, 
        headerStyle: {
          backgroundColor: '#150224', // Your header background color
        },
      }}
    >
      <Tabs.Screen 
