...
const getStyles = (colorScheme, gymColor) => {
    return StyleSheet.create({
        ...
        deleteAllButton: { flexDirection: 'row', alignItems: 'center', paddingVertical: 8, paddingHorizontal: 15, borderRadius: 10 },
        ...
        notificationItem: {
            backgroundColor: Colors[colorScheme].cardBackground, padding: 15, borderRadius: 14, marginBottom: 10, flexDirection: 'row', alignItems: 'center', elevation: 2,
            shadowColor: '#000', shadowOffset: { width: 0, height: 1 }, shadowOpacity: 0.1, shadowRadius: 3, borderWidth: 1, borderColor: Colors[colorScheme].border
        },
        unreadNotification: {
            borderLeftWidth: 4,
