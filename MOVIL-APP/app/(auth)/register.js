...
const RegisterPage = () => {
    ...
    const { register, gymName, gymLogo } = useAuth(); 
...
const getStyles = (colorScheme) => StyleSheet.create({
    ...
    registerButtonContainer: { backgroundColor: '#150224', paddingVertical: 12, borderRadius: 8, alignItems: 'center', justifyContent: 'center', marginTop: 10, height: 50 },
    registerButtonText: { color: '#fff', fontSize: 16, fontWeight: 'bold' },
    loginContainer: { marginTop: 30, flexDirection: 'row', justifyContent: 'center', alignItems: 'center' },
    loginText: { fontSize: 16 },
    loginLink: { fontSize: 16, color: '#007BFF', fontWeight: 'bold', marginLeft: 5 },
});
